...
function GuestLine(props) {
    ...
    return (
        <li className="event-view-box list-group-item d-flex lh-condensed" >
            ...
            <button onClick={copyURL} className="btn guest-copy-icon">
                ...
                <span data-direction="nw" aria-label="Copy url to clipboard" role="tooltip" className="copy-url-popover">
                    Copy guest's url to clipboard
                </span>
            </button>
